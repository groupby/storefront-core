...
class Alias {
  ...
  oldState: object = this.tag.state;

  constructor(public tag: Tag) {
    tag.on(Phase.INITIALIZE, this.onInitialize);
  }
  ...
  //   this.tag.on(Phase.BEFORE_MOUNT, this.onBeforeMount);
  //   this.tag.on(Phase.UPDATE_PROPS, this.onUpdate);
  // }
  ...
  static attach(tag: Tag) {
    return new Alias(tag);
  }
}
