...
suite('URL Service', ({ expect, spy, stub, itShouldBeCore, itShouldExtendBaseService }) => {
  ...
  describe('triggerRequestFromUrl()', () => {
    describe('SEARCH', () => {
      it('should build request and fetch', () => {
        ...
        service.triggerRequestFromUrl(Routes.SEARCH, urlState);
    ...
    describe('PAST_PURCHASE', () => {
      it('should build request and fetch', () => {
        ...
        service.triggerRequestFromUrl(Routes.PAST_PURCHASE, urlState);
    ...
    describe('DETAILS', () => {
      it('should build request and fetch', () => {
        ...
        service.triggerRequestFromUrl(Routes.DETAILS, urlState);
